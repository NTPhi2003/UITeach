        ...
        <View style={styles.header}>
          ...
          <View style={styles.buttons}>
            <TouchableOpacity
              style={[
                styles.button,
                selected === 'all' && styles.selectedButton,
              ]}
            ...
            >
              <Text
                style={[
                  styles.buttonText,
                  selected === 'all' && styles.selectedText,
                ]}
              >
                Tất cả
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.button,
                selected === 'math' && styles.selectedButton,
              ]}
            ...
            >
              <Text
                style={[
                  styles.buttonText,
                  selected === 'math' && styles.selectedText,
                ]}
              >
                Toán đại cương
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.button,
                selected === 'IT' && styles.selectedButton,
              ]}
            ...
            >
              <Text
                style={[
                  styles.buttonText,
                  selected === 'IT' && styles.selectedText,
                ]}
              >
                Cơ sở ngành
              </Text>
